    ...
    <body>
        <form action="index.html">
            ...
            <%  
                ...
                int status = A.modRecord(donorid, entry_firstname, entry_middlename, entry_lastname,
                                         entry_gender, str_birthday, entry_mobileno, entry_filepath);

                int age = A.calculateAge(LocalDate.parse(str_birthday), LocalDate.now());
